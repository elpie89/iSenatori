define(["zepto", "underscore", "backbone", "handlebars", "text!tpl/prod_list_tpl.html", 
            "models/ProductModel", "collections/ProductList","wall/ProdListItemView"],
        function($, _, Backbone, Handlebars, template, ProductModel, ProductList, ProdListItemView) {

           var ProdListItem = Backbone.View.extend({
